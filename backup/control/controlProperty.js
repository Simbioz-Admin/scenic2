define(
    ...
    function ( _, Backbone, BoxTemplate, DestinationTemplate ) {
        /**
         *    @constructor
         *  @requires Underscore
         *  @requires Backbone
        ...
        var ControlPropertyView = Backbone.View.extend(
            /**
...

            {
                ...
                initialize: function ( options ) {
                    ...
                    var that     = this,
                        template = _.template( DestinationTemplate )( this.model.toJSON() );
                    ...
                    $( ".shmdata", $(this) ).each( function ( index, source ) {
                        $( this ).append( boxTemplate( {
                            status:        null,
                            name:          'connect-properties',
                            destinationId: that.model.get( 'name' ),
                            port:          null
                        } ) );
