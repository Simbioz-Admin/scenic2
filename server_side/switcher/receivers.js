...
var create_destination = function(destination, cb) {
  ...
  var setDestination = switcher.invoke("dico", "update", ["destinationsRtp", JSON.stringify(destinations)]);
  if (!setDestination) {
...
var connect_destination = function(quiddName, path, id, port, portSoap, cb) {
  ...
  var setPropertyValueOfDico = switcher.invoke("dico", "update", ["destinationsRtp", JSON.stringify(destinations)]);
...
var remove_connection = function(path, id, cb) {
  ...
  var destinations_dico = JSON.parse(switcher.invoke("dico", "read", ["destinationsRtp"]));
  ...
  var setPropertyValueOfDico = switcher.invoke("dico", "update", ["destinationsRtp", JSON.stringify(destinations_dico)]);
  if (!setPropertyValueOfDico) return cb("error when saving Destinations Dico");
